...
export default function VisitorOrderPage() {
  ...
  const selectedCartProducts = Object.entries(cart)
    .map(([productId, value]) => {
      ...
      return { product, value, lineTotal: calculateDualPrice(product, value) };
    })
    .filter(Boolean) as Array<{ product: any; value: DualQuantity; lineTotal: number }>;
                ...
                {products.map((product) => {
                  ...
                  return (
                    <article
                      ...
                      : <DualQuantitySelector product={product} value={value} onChange={(next) => updateCart(product.id, next)} accent="blue" />}
                    ...
                    <div
                      ...
                      <div className="flex min-w-0 items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="mt-1 text-xs text-gray-500">
                            ...
                            ریال / {product.unitType || "واحد کلی"}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between gap-3 sm:flex-col sm:items-end">
                        <span className="rounded-full bg-blue-100 px-3 py-1 text-sm font-bold text-blue-700">
                          {value.whole.toLocaleString("fa-IR")} {product.unitType || "کلی"} + {value.partial.toLocaleString("fa-IR")} {product.subUnitType || "جزئی"}
                        </span>
